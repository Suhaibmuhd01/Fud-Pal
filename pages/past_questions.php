...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen">
    ...
    <div class="flex">
        ...
        <aside id="sidebar"
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex flex-col">
                        <span class="font-semibold text-base text-white">
                            <?php echo htmlspecialchars($_SESSION['fullname'] ?? 'Student'); ?> </span>
                        <span class="text-xs text-green-200"> <?php echo htmlspecialchars($_SESSION['regnum'] ?? ''); ?>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <nav class="py-4">
                ...
                <div class="mt-3 px-4">
                    <a href="../logout.php"
                        class="flex items-center space-x-3text-white rounded-lg hover:bg-red-700 transition-colors">
    ...
    <!-- Success/Error Popup -->
    <div id="upload-popup" class="fixed inset-0 z-50 items-center justify-center hidden">
        <div class="flex min-h-screen items-center justify-center fixed inset-0 z-50 bg-black bg-opacity-40">
            <div
