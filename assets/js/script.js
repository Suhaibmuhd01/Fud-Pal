...
//         type: 'bar',
//         data: {
//             labels: ['Library', 'Computer Lab', 'Study Rooms', 'Online Resources', 'E-Library'],
//             datasets: [{
//                 label: 'Usage Hours',
//                 data: [42, 35, 28, 50, 33],
//                 backgroundColor: [
...
//         resourcesChart.options.scales.y.grid = {
//             color: isDarkMode ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.1)'
//         };

//         resourcesChart.options.scales.x.grid = {
//             color: isDarkMode ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.1)'
//         };

//         resourcesChart.options.scales.y.ticks = {
//             color: isDarkMode ? 'rgba(255, 255, 255, 0.7)' : 'rgba(0, 0, 0, 0.7)'
//         };

//         resourcesChart.options.scales.x.ticks = {
//             color: isDarkMode ? 'rgba(255, 255, 255, 0.7)' : 'rgba(0, 0, 0, 0.7)'
//         };
...
//     // Initialize chart colors based on current mode
//     updateChartColors();
